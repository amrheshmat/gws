...
namespace SampleMVC.Controllers
{
    public class LanguageController : Controller
    {
        ...
        public async Task<Response> Add([FromBody] Language languageModel)
        {
            ...
            if (Language != null)
            {
                response.Message = _localizationService.Localize("AddLanguage");
                response.Status = true;
                return response;
            }
            response.Message = _localizationService.Localize("AddLanguageError");
        ...
        public async Task<Response> Edit([FromBody] Language languageModel)
        {
            ...
            if (Language != null)
            {
                response.Message = _localizationService.Localize("UpdateLanguage");
                response.Status = true;
                return response;
            }
            response.Message = _localizationService.Localize("UpdateLanguageError");
            response.Status = false;
            return response;
        }
        ...
        public async Task<Response> Delete(int id)
        {
            ...
            if (language != null)
            {
                ...
                response.Message = _localizationService.Localize("DeleteLanguage");
                response.Status = true;
                return response;
            }
            response.Message = _localizationService.Localize("DeleteLanguageError");
            response.Status = false;
            return response;
        }
    }
