...
namespace SampleMVC.Controllers
{
    public class LocalizationController : Controller
    {
        ...
        public LocalizationController(ITripCaching tripCaching, ILocalizationService localizationService, IRepositoryFactory repo)
        {
        ...
        public async Task<Response> Edit([FromBody] Localization localizationModel)
        {
            ...
            if (oldLocalize != null)
            {
                ...
                {
                    _tripCaching.UpdateTranlsation(localizationModel.languageId.Value);
        ...
        public async Task<Response> Delete(int id)
        {
            ...
            if (localization != null)
            {
                ...
                _tripCaching.UpdateTranlsation(localization.languageId.Value);
